	...
	<div class="flex flex-col gap-5 animate-slide-enter">
		...
		<div class="grid grid-cols-2 gap-4">
			<div class="flex flex-col">
				...
				<span class="text-xs text-fg-secondary">Mock code in prod bundle</span>
			</div>
			<div class="flex flex-col">
				<span class="text-2xl font-bold text-primary">1 env var</span>
				<span class="text-xs text-fg-secondary">Controls everything</span>
			</div>
		</div>
